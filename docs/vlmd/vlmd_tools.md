...
- **Please note that “name” and “description” are required fields** in the HEAL VLMD schema. If your data dictionary does not contain these two fields, it will not pass validation.
